...
angular.module('inspinia').directive('dashboardWidget', function ($compile, $templateCache, dataService, chartService) {

    var renderEchart = function (scope, element, attrs) {
        var template = $templateCache.get("echartContent");
//    	var template = "<div class='col-md-{{widget.width}}' style='height:300px;padding: 3px 0px 3px 13px;' id='echartBox'></div>"; 
