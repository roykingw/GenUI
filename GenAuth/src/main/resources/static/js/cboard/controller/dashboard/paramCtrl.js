 ...
 */
'user strict';
angular.module('inspinia').controller('paramCtrl', function ($scope, $uibModal, $http) {
    ...
    $scope.editParam = function () {
        $uibModal.open({
            templateUrl: 'views/cboard/modal/param.html',
            windowTemplateUrl: 'views/cboard/modal/window.html',
            backdrop: false,
            size: 'lg',
            resolve: {
                param: function () {
